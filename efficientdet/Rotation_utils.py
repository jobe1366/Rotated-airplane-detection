...
class Rotation_BBoxTransform(nn.Module):
    def forward(self, anchors, regression):
        ...
        pw = regression[..., 2].exp() * wa 
        ph = regression[..., 3].exp() * ha  

        px_centers = regression[..., 0] * wa + x_centers_a  
        py_centers = regression[..., 1] * ha + y_centers_a  
        pt = ta + (regression[..., 4] / math.pi) * 180 
...
class Anchors(nn.Module):
    ...
    def __init__(self, anchor_scale= 2., pyramid_levels=None, **kwargs):
        super().__init__()
