...
def get_args():
    ...
    parser.add_argument('--compound_coef', type=int, default=2, help='coefficients of efficientdet')
    ...
    parser.add_argument('--pth', type=str, default='/home/jobe/Rotated_airplane/logs/DOTA_effdet/efficientdet-d2_21_161605.pth',
                        help='the pth file of trained model.')
    parser.add_argument('--txt_path', type=str, default='/home/jobe/Rotated_airplane/evaluation/result_classname/',
                        help='the output path of batch inference results.')
    parser.add_argument('--img_path', type=str, default='/home/jobe/Rotated_airplane/test/images/',
                        help='val set images path')
    parser.add_argument('--file_list', type=str, default='evaluation/imgnamefile.txt',
