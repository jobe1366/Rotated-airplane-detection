...
class splitbase():
    ...
    def saveimagepatches(self, img, subimgname, left, up):
        ...
        outdir = os.path.join(self.outimagepath, subimgname + '.jpg')  #   self.ext 
...
if __name__ == '__main__':
    ...
    split = splitbase(r'/home/jobe/Documents/Rotated_airplane/test',
                       r'/home/jobe/Documents/Rotated_airplane/augg',
                      gap=100,
                      subsize=768,
                      num_process=30
                      )
